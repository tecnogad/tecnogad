...
public class UnplashPublishCollectionController extends HttpServlet {

    /**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static final Logger log = Logger.getLogger(UnplashPublishCollectionController.class.getName());
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        ...
        if (accessToken != null && !"".equals(accessToken)) {
            ...
            log.info("there is access token in publish controler");
            uResource.publish(collectionId);
